...
if ($permissiontowrite) {
	...
	print $form->selectDate($editedConvention->date_reception ? (int) $editedConvention->date_reception : -1, 'date_reception', 1, 1, 1, '', 1, 1);
	...
	print $form->selectDate($editedConvention->date_envoi_client ? (int) $editedConvention->date_envoi_client : -1, 'date_envoi_client', 1, 1, 1, '', 1, 1);
	print '</td></tr>';
	print '<tr><td>'.$langs->trans('ConventionClientSignatureDate').'</td><td>';
	print $form->selectDate($editedConvention->date_signature_client ? (int) $editedConvention->date_signature_client : -1, 'date_signature_client', 1, 1, 1, '', 1, 1);
	print '<div class="opacitymedium">'.$langs->trans('ConventionDocumentDateHelp').'</div>';
	print '</td></tr>';
	print '<tr><td>'.$langs->trans('ConventionReturnEnedisDate').'</td><td>';
	print $form->selectDate($editedConvention->date_retour_enedis ? (int) $editedConvention->date_retour_enedis : -1, 'date_retour_enedis', 1, 1, 1, '', 1, 1);
	print '</td></tr>';
	print '<tr><td>'.$langs->trans('ConventionValidationDate').'</td><td>';
	print $form->selectDate($editedConvention->date_validation ? (int) $editedConvention->date_validation : -1, 'date_validation', 1, 1, 1, '', 1, 1);
	print '</td></tr>';
