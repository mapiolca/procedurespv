...
- Lorsqu’une centrale PV est liée, reprise automatique de ses données disponibles dans le raccordement et la collecte, y compris les puissances installée et de raccordement ; sans centrale liée, les données proviennent du site local. Les corrections saisies lors du mandat sont répercutées dans le raccordement et dans l’objet Centrale PV natif.
